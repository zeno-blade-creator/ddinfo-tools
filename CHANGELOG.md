...
- Added macOS (arm64) support. All features work; live run data in the practice tool requires launching the app with `sudo`, since macOS restricts reading another program's memory otherwise.
